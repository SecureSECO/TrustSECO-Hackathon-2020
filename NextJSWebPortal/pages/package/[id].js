                ...
                <Row>
                  <Col md={8}>
                    <Card>
                      ...
                      <Card.Body>
                        <Card.Subtitle>{postData.description}</Card.Subtitle>
                        <Card.Text>
                          Repository:{" "}
                    ...
                    <Card>
                      ...
                      <Card.Body>
                        <Card.Text>
                          ...
                          <div>
                            one_point_oh: {postData.sourceRank["one_point_oh"]}
                          </div>
                          <div>
                            dependent_projects:{" "}
                          ...
                          <div>
                            contributors: {postData.sourceRank["contributors"]}
                          </div>
                          <div>
                            subscribers: {postData.sourceRank["subscribers"]}
                          </div>
                          <div>
                            all_prereleases:{" "}
                          ...
                          <div>
                            ...
                            {postData.sourceRank["any_outdated_dependencies"]}
                          </div>
                          <div>
                            is_deprecated:{" "}
